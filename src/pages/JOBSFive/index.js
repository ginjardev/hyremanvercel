      ...
      <Column className="bg-gray_200 font-poppins items-center mx-[auto] lg:pr-[15px] xl:pr-[17px] 2xl:pr-[20px] pr-[24px] w-[100%]">
        <Row className="justify-between w-[100%]">
          ...
          <Column className="lg:mb-[353px] xl:mb-[404px] 2xl:mb-[455px] mb-[546px] mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] w-[82%]">
            ...
            <Column className="lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] ml-[29px] lg:mr-[400px] xl:mr-[458px] 2xl:mr-[515px] mr-[618px] lg:mt-[25px] xl:mt-[29px] 2xl:mt-[33px] mt-[40px] w-[54%]">
              <Row className="items-center pr-[3px] py-[3px] w-[100%]">
                <Text className="capitalize font-medium lg:text-[23px] xl:text-[26px] 2xl:text-[30px] text-[36px] text-black_900 w-[auto]">
                  1 Active job
                </Text>
                <SelectBox
                  className="bg-transparent font-bold lg:ml-[39px] xl:ml-[45px] 2xl:ml-[50px] ml-[61px] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-black_900 w-[14%]"
                  ...
                  variant="dropdown0"
                ></SelectBox>
                <Row className="items-center justify-between lg:ml-[57px] xl:ml-[65px] 2xl:ml-[73px] ml-[88px] rounded-radius10 w-[33%]">
                  <Text className="font-bold lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-gray_400 w-[auto]">
                    Sort by
                  </Text>
                  <SelectBox
                    className="bg-transparent font-bold lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-black_900 w-[64%]"
                    placeholderClassName="bg-transparent text-black_900"
                    name="Group152"
              ...
              <Column className="bg-white_A700 border-bw05 border-gray_500 border-solid justify-center lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] mt-[20px] lg:p-[10px] xl:p-[11px] 2xl:p-[13px] p-[16px] rounded-radius20 w-[41%]">
