            ...
            <Row className="items-center justify-between lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] mt-[20px] w-[100%]">
              ...
              <Column className="bg-white_A700 border border-gray_600_33 border-solid items-center 2xl:py-[10px] py-[13px] lg:py-[8px] xl:py-[9px] rounded-radius10 w-[31%]">
                <Row className="items-center justify-between w-[88%]">
                  ...
                  <Row className="bg-bluegray_103 items-center p-[2px] rounded-radius165 w-[46%]">
                    <Button
                      className="font-medium xl:text-[10px] 2xl:text-[11px] text-[14px] lg:text-[9px] text-center w-[49%]"
                    ...
                    <Text className="font-medium lg:ml-[4px] 2xl:ml-[5px] xl:ml-[5px] ml-[7px] xl:text-[10px] 2xl:text-[11px] text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                      Yesterday
                    </Text>
                  </Row>
                </Row>
                <Line className="bg-bluegray_101 h-[1px] 2xl:mt-[10px] mt-[13px] lg:mt-[8px] xl:mt-[9px] w-[100%]" />
                <Button
