    ...
    <>
      <Column className="bg-gray_200 font-poppins items-center mx-[auto] lg:pr-[15px] xl:pr-[17px] 2xl:pr-[20px] pr-[24px] w-[100%]">
        <Row className="justify-between w-[100%]">
          ...
          <Column className="items-center lg:mb-[40px] xl:mb-[45px] 2xl:mb-[51px] mb-[62px] mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] w-[82%]">
            ...
            <Column className="lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] mt-[29px] w-[98%]">
              ...
              <Row className="justify-between lg:mt-[22px] xl:mt-[25px] 2xl:mt-[28px] mt-[34px] w-[100%]">
                <Column className="lg:mb-[206px] xl:mb-[236px] 2xl:mb-[266px] mb-[319px] w-[46%]">
                  ...
                  <Text className="font-medium lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] mt-[29px] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-black_900 w-[auto]">
                    Job Title
                  </Text>
                  <Input
                ...
                <Column className="lg:mt-[37px] xl:mt-[42px] 2xl:mt-[48px] mt-[58px] w-[53%]">
                  ...
                  <Button
                    className="font-normal lg:ml-[335px] xl:ml-[383px] 2xl:ml-[431px] ml-[517px] lg:mt-[25px] xl:mt-[28px] 2xl:mt-[32px] mt-[39px] not-italic lg:text-[11px] xl:text-[13px] 2xl:text-[15px] text-[18px] text-center w-[29%]"
                    shape="RoundedBorder5"
                    size="xl"
...
export default ADDNEWJOBOnePage;
