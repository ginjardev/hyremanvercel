...
const ResumeBankTwoPage = () => {
  const sliderRef = React.useRef();
  const [sliderState, setsliderState] = React.useState(0);

  return (
    <>
      <Stack className="bg-gray_200 font-poppins lg:h-[2037px] xl:h-[2330px] 2xl:h-[2621px] h-[3142px] 3xl:h-[3144px] mx-[auto] lg:pr-[15px] xl:pr-[17px] 2xl:pr-[20px] pr-[24px] w-[100%]">
        ...
        <Column className="absolute bg-white_A700 justify-center left-[19%] lg:p-[27px] xl:p-[31px] 2xl:p-[35px] p-[42px] top-[4%] w-[23%]">
        ...
        <Row className="absolute bg-white_A700 xl:p-[10px] 2xl:p-[11px] p-[14px] lg:p-[9px] right-[0] top-[5%] w-[57%]">
        ...
        <Button
          className="absolute font-normal not-italic right-[22%] xl:text-[10px] 2xl:text-[11px] text-[14px] lg:text-[9px] text-center top-[4%] w-[5%]"
        ...
        <Text className="absolute font-medium left-[42%] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-black_900 top-[4%] w-[auto]">
          20 results
        </Text>
        <Button
          className="absolute font-medium right-[15%] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-center top-[4%] w-[2%]"
          size="md"
        ...
        <Button
          className="absolute font-medium right-[12%] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-center top-[4%] w-[2%]"
          size="md"
          variant="FillWhiteA700"
        >
          2
        ...
        <Button
          className="absolute font-medium right-[10%] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-center top-[4%] w-[2%]"
          size="md"
          variant="FillWhiteA700"
        >
          3
        ...
        <Button
          className="absolute font-medium right-[7%] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-center top-[4%] w-[3%]"
          size="md"
          variant="FillWhiteA700"
        >
          4
        </Button>
        <div className="absolute bg-white_A700 lg:h-[26px] xl:h-[30px] 2xl:h-[34px] h-[40px] 3xl:h-[41px] right-[4%] top-[4%] w-[2%]"></div>
        <div className="absolute bg-white_A700 lg:h-[26px] xl:h-[30px] 2xl:h-[34px] h-[40px] 3xl:h-[41px] right-[18%] rotate-[180deg] top-[4%] w-[2%]"></div>
        <aside className="absolute items-center left-[0] w-[17%]">
          <Column className="">
            <Column className="bg-black_900 lg:p-[13px] xl:p-[15px] 2xl:p-[17px] p-[21px] w-[100%]">
              ...
              <Row className="items-center lg:mt-[1632px] xl:mt-[1867px] 2xl:mt-[2100px] mt-[2519px] 3xl:mt-[2520px] rounded-radius5 w-[100%]">
                <Img
              ...
              <Row className="items-center lg:mb-[57px] xl:mb-[65px] 2xl:mb-[74px] mb-[89px] ml-[2px] lg:mt-[28px] xl:mt-[32px] 2xl:mt-[36px] mt-[44px] rounded-radius5 w-[99%]">
                <Img
...
export default ResumeBankTwoPage;
