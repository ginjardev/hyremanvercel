    ...
    <>
      <Column className="bg-gray_200 font-poppins items-center mx-[auto] lg:pr-[15px] xl:pr-[17px] 2xl:pr-[20px] pr-[24px] w-[100%]">
        <Row className="justify-evenly w-[100%]">
          ...
          <Column className="items-center lg:mb-[383px] xl:mb-[438px] 2xl:mb-[493px] mb-[592px] mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] w-[81%]">
            ...
            <Row className="items-center justify-between lg:mt-[24px] xl:mt-[28px] 2xl:mt-[31px] mt-[38px] w-[100%]">
              ...
              <Column className="bg-white_A700 items-center lg:p-[12px] xl:p-[14px] 2xl:p-[15px] p-[19px] rounded-radius10 shadow-bs w-[31%]">
                <Row className="bg-gray_405 items-center ml-[auto] p-[2px] rounded-radius16 w-[38%]">
                  <Button
                ...
                <Button
                  className="font-medium lg:mb-[54px] xl:mb-[62px] 2xl:mb-[70px] mb-[84px] lg:mt-[31px] xl:mt-[36px] 2xl:mt-[40px] mt-[49px] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-center w-[26%]"
                  shape="RoundedBorder10"
                  size="md"
                  variant="FillGray400"
                >
