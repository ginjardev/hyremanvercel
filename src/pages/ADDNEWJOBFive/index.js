    ...
    <>
      <Column className="bg-gray_200 font-poppins items-center mx-[auto] lg:pr-[15px] xl:pr-[17px] 2xl:pr-[20px] pr-[24px] w-[100%]">
        <Row className="justify-between w-[100%]">
          ...
          <Column className="lg:mb-[134px] xl:mb-[154px] 2xl:mb-[173px] mb-[208px] mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] w-[82%]">
            ...
            <Text className="capitalize font-normal ml-[10px] lg:ml-[6px] xl:ml-[7px] 2xl:ml-[8px] 2xl:mr-[1003px] mr-[1203px] lg:mr-[779px] xl:mr-[891px] lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] mt-[29px] not-italic lg:text-[18px] xl:text-[20px] 2xl:text-[23px] text-[28px] text-black_900 w-[auto]">
              Add New Job
            </Text>
            <Row className="items-center ml-[10px] lg:ml-[6px] xl:ml-[7px] 2xl:ml-[8px] lg:mr-[556px] xl:mr-[636px] 2xl:mr-[716px] mr-[859px] lg:mt-[22px] xl:mt-[25px] 2xl:mt-[28px] mt-[34px] w-[38%]">
            ...
            <Text className="font-medium ml-[10px] lg:ml-[6px] xl:ml-[7px] 2xl:ml-[8px] 2xl:mr-[1089px] mr-[1306px] lg:mr-[846px] xl:mr-[968px] lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] mt-[29px] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-black_900 w-[auto]">
              Full Name
            </Text>
            <Input
              ...
              wrapClassName="2xl:ml-[8px] 2xl:mr-[642px] 2xl:mt-[4px] lg:ml-[6px] lg:mr-[499px] lg:mt-[3px] ml-[10px] mr-[771px] mt-[5px] w-[44%] xl:ml-[7px] xl:mr-[571px] xl:mt-[3px]"
              name="Input"
              placeholder="Enter full name"
              shape="RoundedBorder5"
              size="sm"
            ></Input>
            <Row className="ml-[10px] lg:ml-[6px] xl:ml-[7px] 2xl:ml-[8px] lg:mr-[110px] xl:mr-[126px] 2xl:mr-[141px] mr-[170px] lg:mt-[10px] xl:mt-[11px] 2xl:mt-[13px] mt-[16px] w-[87%]">
              <Column className="lg:pr-[172px] xl:pr-[197px] 2xl:pr-[221px] pr-[266px] w-[72%]">
              ...
              <Row className="border border-gray_402 border-solid items-center justify-center mb-[112px] lg:mb-[72px] xl:mb-[83px] 2xl:mb-[93px] xl:mt-[106px] 2xl:mt-[120px] mt-[144px] lg:mt-[93px] lg:p-[14px] xl:p-[17px] 2xl:p-[19px] p-[23px] rounded-radius10 w-[28%]">
                <Img
                  ...
                  alt="plus"
                />
                <Text className="font-medium lg:ml-[12px] xl:ml-[14px] 2xl:ml-[15px] ml-[19px] lg:mr-[33px] xl:mr-[37px] 2xl:mr-[42px] mr-[51px] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-black_900 w-[auto]">
                  Add Assessment
                </Text>
              </Row>
            </Row>
            <Row className="items-center ml-[10px] lg:ml-[6px] xl:ml-[7px] 2xl:ml-[8px] lg:mr-[499px] xl:mr-[571px] 2xl:mr-[642px] mr-[771px] lg:mt-[11px] xl:mt-[12px] 2xl:mt-[14px] mt-[17px] w-[44%]">
            ...
            <Row className="items-center 2xl:mr-[10px] mr-[13px] lg:mr-[8px] xl:mr-[9px] lg:mt-[23px] xl:mt-[27px] 2xl:mt-[30px] mt-[37px] w-[99%]">
              <Button
                className="font-normal not-italic lg:text-[11px] xl:text-[13px] 2xl:text-[15px] text-[18px] text-center w-[11%]"
                shape="RoundedBorder5"
                size="xl"
              ...
              <Button
                className="font-normal lg:ml-[541px] xl:ml-[619px] 2xl:ml-[697px] ml-[836px] not-italic lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-center w-[10%]"
                shape="RoundedBorder5"
                size="xl"
              ...
              <Button
                className="font-normal lg:ml-[25px] xl:ml-[28px] 2xl:ml-[32px] ml-[39px] not-italic lg:text-[11px] xl:text-[13px] 2xl:text-[15px] text-[18px] text-center w-[15%]"
                shape="RoundedBorder5"
                size="xl"
                variant="FillBlack900"
              >
...
export default ADDNEWJOBFivePage;
