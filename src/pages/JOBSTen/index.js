      ...
      <Column className="bg-white_A700 font-poppins items-center mx-[auto] lg:pr-[25px] xl:pr-[29px] 2xl:pr-[33px] pr-[40px] w-[100%]">
        <Row className="justify-evenly w-[100%]">
          ...
          <Column className="lg:mb-[387px] xl:mb-[443px] 2xl:mb-[498px] mb-[598px] lg:mt-[15px] xl:mt-[17px] 2xl:mt-[20px] mt-[24px] w-[81%]">
              ...
              <SelectBox
                ...
                indicator={
                  <Img
                    ...
                    className="w-[10.5px] h-[4.73px] mr-[0] lg:w-[6px] lg:h-[4px] xl:w-[7px] xl:h-[4px] 2xl:w-[8px] 2xl:h-[4px] 3xl:w-[10px] 3xl:h-[5px]"
                    alt="arrow_down"
                  />
                }
            ...
            <Column className="bg-white_A700 border-bw05 border-gray_500 border-solid items-center lg:mt-[20px] xl:mt-[23px] 2xl:mt-[26px] mt-[32px] lg:p-[11px] xl:p-[12px] 2xl:p-[14px] p-[17px] rounded-radius20 w-[22%]">
              ...
              <Text className="font-bold leading-[normal] mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] lg:text-[15px] xl:text-[17px] 2xl:text-[20px] text-[24px] text-black_900 w-[91%]">
                JUNIOR MOBILE <br />
                DEVELOPER
              </Text>
