    ...
    <>
      <Column className="bg-white_A700 font-poppins items-center mx-[auto] w-[100%]">
        <Row className="justify-evenly w-[100%]">
          ...
          <Column className="lg:mb-[458px] xl:mb-[524px] 2xl:mb-[590px] mb-[708px] lg:mt-[15px] xl:mt-[17px] 2xl:mt-[20px] mt-[24px] w-[82%]">
            ...
            <Row className="xl:ml-[11px] 2xl:ml-[12px] ml-[15px] lg:ml-[9px] lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] mt-[20px] w-[92%]">
              <Button
                className="flex items-center justify-center lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] mt-[9px] rotate-[180deg] w-[5%]"
            ...
            <Row className="ml-[1px] lg:mt-[33px] xl:mt-[38px] 2xl:mt-[43px] mt-[52px] w-[96%]">
              ...
              <Button
                className="font-normal mb-[10px] lg:mb-[6px] xl:mb-[7px] 2xl:mb-[8px] lg:ml-[508px] xl:ml-[581px] 2xl:ml-[653px] ml-[784px] not-italic xl:text-[10px] 2xl:text-[11px] text-[14px] lg:text-[9px] text-center w-[11%]"
                shape="RoundedBorder10"
                size="md"
                variant="FillBlue800"
              >
            ...
            <Stack className="h-[2px] 3xl:h-[3px] lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] mt-[18px] w-[100%]">
            ...
            <Row className="bg-bluegray_102 items-center lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] mt-[9px] lg:p-[14px] xl:p-[17px] 2xl:p-[19px] p-[23px] rounded-bl-[0] rounded-br-[0] rounded-tl-[10px] rounded-tr-[10px] w-[97%]">
              <CheckBox
            ...
            <Row className="lg:ml-[27px] xl:ml-[31px] 2xl:ml-[35px] ml-[42px] 2xl:mt-[10px] mt-[13px] lg:mt-[8px] xl:mt-[9px] w-[93%]">
              ...
              ></CheckBox>
              <Text className="font-normal mb-[1px] lg:ml-[29px] xl:ml-[33px] 2xl:ml-[37px] ml-[45px] not-italic lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-black_900 w-[auto]">
...
export default ResumeBankFivePage;
