    ...
    <>
      <Column className="bg-gray_200 font-poppins items-center mx-[auto] lg:pr-[15px] xl:pr-[17px] 2xl:pr-[20px] pr-[24px] w-[100%]">
        <Row className="justify-evenly w-[100%]">
          ...
          <Column className="items-center lg:mb-[385px] xl:mb-[440px] 2xl:mb-[495px] mb-[594px] mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] w-[81%]">
            ...
            <Row className="items-center justify-between lg:mt-[23px] xl:mt-[26px] 2xl:mt-[30px] mt-[36px] w-[100%]">
              ...
              <div className="overflow-x-auto w-[31%]">
                <Column className="bg-white_A700 items-center overflow-auto lg:py-[12px] xl:py-[14px] 2xl:py-[16px] py-[20px] rounded-radius10 shadow-bs w-[100%]">
                  ...
                  <Text className="capitalize font-bold mt-[104px] lg:mt-[67px] xl:mt-[77px] 2xl:mt-[86px] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-gray_404 w-[auto]">
                    No candidates available
                  </Text>
                  <Button
                    className="font-medium lg:mb-[55px] xl:mb-[63px] 2xl:mb-[70px] mb-[85px] lg:mt-[31px] xl:mt-[35px] 2xl:mt-[40px] mt-[48px] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-center w-[24%]"
                    shape="RoundedBorder10"
                    size="md"
                    variant="FillGray400"
                  >
              ...
              <Column className="bg-white_A700 lg:p-[10px] xl:p-[11px] 2xl:p-[13px] p-[16px] rounded-radius10 shadow-bs w-[31%]">
                <Row className="bg-gray_405 items-center ml-[auto] mt-[3px] p-[2px] rounded-radius16 w-[37%]">
                  <Button
                    className="font-medium 2xl:text-[10px] text-[13px] lg:text-[8px] xl:text-[9px] text-center w-[40%]"
                ...
                <Text className="capitalize font-bold lg:ml-[60px] xl:ml-[69px] 2xl:ml-[78px] ml-[94px] lg:mr-[46px] xl:mr-[53px] 2xl:mr-[60px] mr-[72px] 2xl:mt-[110px] mt-[133px] lg:mt-[86px] xl:mt-[98px] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-gray_404 w-[auto]">
                  no appointments available
                </Text>
                <Button
                  className="font-medium lg:mb-[56px] xl:mb-[64px] 2xl:mb-[72px] mb-[87px] lg:mt-[31px] xl:mt-[36px] 2xl:mt-[40px] mt-[49px] mx-[auto] lg:text-[10px] xl:text-[11px] 2xl:text-[13px] text-[16px] text-center w-[25%]"
                  shape="RoundedBorder10"
                  size="md"
                  variant="FillGray400"
                >
